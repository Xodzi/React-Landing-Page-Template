  ...
  return (
    <div id="features" className="text-center">
      <div style={{}} className="">
        ...
        <Carousel centerSlidePercentage={50} centerMode={true} showThumbs={false} infiniteLoop={false} showIndicators={true} showStatus={false} style={{backgroundColor: 'rgb(246, 246, 246)'}}
